...
const InterfaceDeCadastro = () => {
  ...
  // Desestruturação dos resultados da validação
  const { lengthValid, specialCharValid, numberValid, uppercaseValid } =
      ...
      >
        ...
        <View style={styles.passwordRequirements}>
          <View style={styles.passwordRequirementItem}>
            <MaterialCommunityIcons
              name={lengthValid ? "check-circle" : "close-circle"}
              size={20}
              color={lengthValid ? "green" : "red"}
              style={{ marginRight: 8 }}
            />
            <Text style={lengthValid ? styles.valid : styles.invalid}>
              8 caracteres
            </Text>
          </View>
          ...
          <View style={styles.passwordRequirementItem}>
            <MaterialCommunityIcons
              name={uppercaseValid ? "check-circle" : "close-circle"}
              size={20}
              color={uppercaseValid ? "green" : "red"}
              style={{ marginRight: 8 }}
            />
            <Text style={uppercaseValid ? styles.valid : styles.invalid}>
              1 letra maiúscula
            </Text>
          </View>
          ...
          <View style={styles.passwordRequirementItem}>
            <MaterialCommunityIcons
              name={specialCharValid ? "check-circle" : "close-circle"}
              size={20}
              color={specialCharValid ? "green" : "red"}
              style={{ marginRight: 8 }}
            />
            <Text style={specialCharValid ? styles.valid : styles.invalid}>
          ...
          <View style={styles.passwordRequirementItem}>
            <MaterialCommunityIcons
              name={numberValid ? "check-circle" : "close-circle"}
              size={20}
              color={numberValid ? "green" : "red"}
              style={{ marginRight: 8 }}
            />
            <Text style={numberValid ? styles.valid : styles.invalid}>
              1 número
            </Text>
          </View>
        </View>
